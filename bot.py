...
async def send_welcome(message: types.Message):
    text = (
        ...
        "<i>These secrets only work on our verified partner platform where our winning algorithms are optimized.</i>\n\n"
        "• Deposit your starting bank (minimum $30).\n"
        "• Send a screenshot of your registration to unlock the full 5-Method Guide instantly!\n\n"
        "⚠️ <b>Spots are strictly limited!</b> Register now, fund your $30, and start winning today."
    )
